...
class MarketableConferenceForm(messages.Message):
    """ConferenceForm -- Conference outbound form message"""
    name = messages.StringField(1)
    topics = messages.StringField(2, repeated=True)
    city = messages.StringField(3)
    seatsAvailable = messages.IntegerField(5)
    endDate = messages.StringField(6)  # DateTimeField()
...
class MarketableConferenceForms(messages.Message):
    """ConferenceLiteForms -- multiple truncated Conference
    outbound form messages"""
    items = messages.MessageField(MarketableConferenceForm, 1, repeated=True)
...
class SpeakerForm(messages.Message):
    """SpeakerForm -- Session speaker form"""
    name = messages.StringField(1)
